...
import fr.sorbonne_u.components.hem2023.equipements.productionUnit.gasGenerator.connectors.GasGeneratorConnector;
...
import fr.sorbonne_u.components.hem2023.equipements.productionUnit.gasGenerator.ports.GasGeneratorOutboundPort;
import fr.sorbonne_u.components.hem2023.test.CVMIntegrationTest;
...
public class GasGeneratorTester extends AbstractComponent {
	...
	public void testAddBattery() throws Exception {
		this.logMessage("testAddBattery()... ");
		
		this.ggop.turnOn();
		double x = this.ggop.getBattery();
		this.ggop.addBattery(100.0);
		assertTrue(x + 100.0 == this.ggop.getBattery());
	}
