...
import fr.sorbonne_u.components.hem2023.equipements.waterHeating.mil.WaterHeatingElectricityModel.State;
 ...
 *
 */
public class SetPowerWaterHeating extends ES_Event implements WaterHeatingEventI {
	 ...
	 * @param content			the power value to be set on the water heater when the event will be executed.
	 */
	public SetPowerWaterHeating(
	...
	public boolean	hasPriorityOver(EventI e){
		if (e instanceof SwitchOffWaterHeating) {
			return true;
		} else {
			return false;
		}
